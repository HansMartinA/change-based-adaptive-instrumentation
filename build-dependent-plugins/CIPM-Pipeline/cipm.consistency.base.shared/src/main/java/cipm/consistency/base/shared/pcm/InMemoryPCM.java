...
public class InMemoryPCM {
	...
	public static class InMemoryPCMBuilder {
		...
		public InMemoryPCMBuilder repository(Repository repository) {
			this.repository = repository;
			return this;
		}
		
		public InMemoryPCMBuilder system(System system) {
			this.system = system;
			return this;
		}
		
		public InMemoryPCMBuilder usageModel(UsageModel usageModel) {
			this.usageModel = usageModel;
			return this;
		}
		
		public InMemoryPCMBuilder allocationModel(Allocation allocationModel) {
			this.allocationModel = allocationModel;
			return this;
		}
		
		public InMemoryPCMBuilder resourceEnvironmentModel(ResourceEnvironment resourceEnvironmentModel) {
	...
	public static InMemoryPCMBuilder builder() {
		return new InMemoryPCMBuilder();
	}
