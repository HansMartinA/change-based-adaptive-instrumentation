...
public class EChangePackageImpl extends EPackageImpl implements EChangePackage
{
	...
	public static EChangePackage init()
	{
		...
		Object registeredEChangePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		EChangePackageImpl theEChangePackage = registeredEChangePackage instanceof EChangePackageImpl ? (EChangePackageImpl)registeredEChangePackage : new EChangePackageImpl();
