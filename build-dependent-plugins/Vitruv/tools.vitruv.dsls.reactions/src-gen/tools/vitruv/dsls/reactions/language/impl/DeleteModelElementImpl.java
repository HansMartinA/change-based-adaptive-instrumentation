 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.DeleteModelElementImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteModelElementImpl extends ActionStatementImpl implements DeleteModelElement
{
  ...
  {
    return LanguagePackage.Literals.DELETE_MODEL_ELEMENT;
  }
  ...
  public NotificationChain basicSetElement(ExistingElementReference newElement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.DELETE_MODEL_ELEMENT__ELEMENT, oldElement, newElement);
  ...
  public void setElement(ExistingElementReference newElement)
  {
    if (newElement != element)
    {
      ...
      if (element != null)
        msgs = ((InternalEObject)element).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.DELETE_MODEL_ELEMENT__ELEMENT, null, msgs);
      if (newElement != null)
        msgs = ((InternalEObject)newElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.DELETE_MODEL_ELEMENT__ELEMENT, null, msgs);
      msgs = basicSetElement(newElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.DELETE_MODEL_ELEMENT__ELEMENT, newElement, newElement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LanguagePackage.DELETE_MODEL_ELEMENT__ELEMENT:
