 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.ElementDeletionAndRemovalChangeTypeImpl#getDeleteChange <em>Delete Change</em>}</li>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.ElementDeletionAndRemovalChangeTypeImpl#getRemoveChange <em>Remove Change</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDeletionAndRemovalChangeTypeImpl extends ElementCompoundChangeTypeImpl implements ElementDeletionAndRemovalChangeType
{
  ...
  {
    return LanguagePackage.Literals.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE;
  }
  ...
  public NotificationChain basicSetDeleteChange(ElementDeletionChangeType newDeleteChange, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__DELETE_CHANGE, oldDeleteChange, newDeleteChange);
  ...
  public void setDeleteChange(ElementDeletionChangeType newDeleteChange)
  {
    if (newDeleteChange != deleteChange)
    {
      ...
      if (deleteChange != null)
        msgs = ((InternalEObject)deleteChange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__DELETE_CHANGE, null, msgs);
      if (newDeleteChange != null)
        msgs = ((InternalEObject)newDeleteChange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__DELETE_CHANGE, null, msgs);
      msgs = basicSetDeleteChange(newDeleteChange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__DELETE_CHANGE, newDeleteChange, newDeleteChange));
  }
  ...
  public NotificationChain basicSetRemoveChange(ElementRemovalChangeType newRemoveChange, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__REMOVE_CHANGE, oldRemoveChange, newRemoveChange);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRemoveChange(ElementRemovalChangeType newRemoveChange)
  {
    if (newRemoveChange != removeChange)
    {
      ...
      if (removeChange != null)
        msgs = ((InternalEObject)removeChange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__REMOVE_CHANGE, null, msgs);
      if (newRemoveChange != null)
        msgs = ((InternalEObject)newRemoveChange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__REMOVE_CHANGE, null, msgs);
      msgs = basicSetRemoveChange(newRemoveChange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__REMOVE_CHANGE, newRemoveChange, newRemoveChange));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__DELETE_CHANGE:
        return basicSetDeleteChange(null, msgs);
      case LanguagePackage.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__REMOVE_CHANGE:
