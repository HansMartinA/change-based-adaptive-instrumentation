...
public interface LanguageFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Execute Action Statement</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Execute Action Statement</em>'.
   * @generated
   */
  ExecuteActionStatement createExecuteActionStatement();
