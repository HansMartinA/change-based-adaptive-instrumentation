...
public abstract class AbstractReactionsLanguageSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ElementsPackage.eINSTANCE)
			...
			case LanguagePackage.CREATE_MODEL_ELEMENT:
				sequence_CreateModelElementStatement(context, (CreateModelElement) semanticObject); 
				return; 
			...
			case LanguagePackage.EXECUTE_ACTION_STATEMENT:
				sequence_CodeBlock_ExecuteActionStatement(context, (ExecuteActionStatement) semanticObject); 
				return; 
			...
			case LanguagePackage.REMOVE_CORRESPONDENCE:
				sequence_RemoveCorrespondenceStatement_Taggable(context, (RemoveCorrespondence) semanticObject); 
				return; 
			case LanguagePackage.REQUIRE_ABSCENCE_OF_MODEL_ELEMENT:
				if (rule == grammarAccess.getRequireAbscenceOfModelElementRule()) {
					sequence_RequireAbscenceOfModelElement(context, (RequireAbscenceOfModelElement) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getMatcherStatementRule()
						|| rule == grammarAccess.getRetrieveOrRequireAbscenceOfModelElementRule()) {
					sequence_RequireAbscenceOfModelElement_RetrieveOrRequireAbscenceOfModelElement_Taggable(context, (RequireAbscenceOfModelElement) semanticObject); 
					return; 
				}
				else break;
			...
			case LanguagePackage.RETRIEVE_MODEL_ELEMENT:
				if (rule == grammarAccess.getRetrieveModelElementRule()) {
					sequence_RetrieveModelElement(context, (RetrieveModelElement) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getMatcherStatementRule()
						|| rule == grammarAccess.getRetrieveOrRequireAbscenceOfModelElementRule()) {
					sequence_RetrieveModelElement_RetrieveOrRequireAbscenceOfModelElement_Taggable(context, (RetrieveModelElement) semanticObject); 
					return; 
				}
				else break;
			...
			case TopLevelElementsPackage.ACTION:
				sequence_ActionBlock(context, (tools.vitruv.dsls.reactions.language.toplevelelements.Action) semanticObject); 
				return; 
			...
			case TopLevelElementsPackage.REACTION_ROUTINE_CALL:
				sequence_CodeBlock(context, (ReactionRoutineCall) semanticObject); 
				return; 
	 ...
	 */
	protected void sequence_ActionBlock(ISerializationContext context, tools.vitruv.dsls.reactions.language.toplevelelements.Action semanticObject) {
	...
	protected void sequence_CodeBlock_CorrespondingObjectCodeBlock(ISerializationContext context, CorrespondingObjectCodeBlock semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TopLevelElementsPackage.Literals.CODE_BLOCK__CODE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TopLevelElementsPackage.Literals.CODE_BLOCK__CODE));
		}
	...
	/**
	 * Contexts:
	 *     ActionStatement returns ExecuteActionStatement
	 *     ExecuteActionStatement returns ExecuteActionStatement
	 *
	 * Constraint:
	 *     code=XExpression
	 */
	protected void sequence_CodeBlock_ExecuteActionStatement(ISerializationContext context, ExecuteActionStatement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TopLevelElementsPackage.Literals.CODE_BLOCK__CODE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TopLevelElementsPackage.Literals.CODE_BLOCK__CODE));
		}
	 ...
	 *
	 * Constraint:
	 *     (asserted?='asserted'? code=XExpression)
	 */
	 ...
	 *     code=XExpression
	 */
	protected void sequence_CodeBlock(ISerializationContext context, ReactionRoutineCall semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TopLevelElementsPackage.Literals.CODE_BLOCK__CODE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TopLevelElementsPackage.Literals.CODE_BLOCK__CODE));
		}
	 ...
	 *
	 * Constraint:
	 *     (name=ValidID elementType=UnnamedMetaclassReference initializationBlock=ExecutionCodeBlock?)
	 */
	protected void sequence_CreateModelElementStatement(ISerializationContext context, CreateModelElement semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_DeleteModelElementStatement(ISerializationContext context, DeleteModelElement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.DELETE_MODEL_ELEMENT__ELEMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.DELETE_MODEL_ELEMENT__ELEMENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_DomainReference(ISerializationContext context, DomainReference semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ElementsPackage.Literals.DOMAIN_REFERENCE__DOMAIN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ElementsPackage.Literals.DOMAIN_REFERENCE__DOMAIN));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDomainReferenceAccess().getDomainValidIDParserRuleCall_0(), semanticObject.getDomain());
		feeder.finish();
	}
	...
	protected void sequence_ElementCreationAndInsertionChangeType(ISerializationContext context, ElementCreationAndInsertionChangeType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.ELEMENT_CREATION_AND_INSERTION_CHANGE_TYPE__CREATE_CHANGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.ELEMENT_CREATION_AND_INSERTION_CHANGE_TYPE__CREATE_CHANGE));
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.ELEMENT_CREATION_AND_INSERTION_CHANGE_TYPE__INSERT_CHANGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.ELEMENT_CREATION_AND_INSERTION_CHANGE_TYPE__INSERT_CHANGE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ElementDeletionAndCreationAndReplacementChangeType(ISerializationContext context, ElementDeletionAndCreationAndReplacementChangeType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__DELETE_CHANGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__DELETE_CHANGE));
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__CREATE_CHANGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__CREATE_CHANGE));
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__REPLACED_CHANGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__REPLACED_CHANGE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ElementDeletionAndRemovalChangeType(ISerializationContext context, ElementDeletionAndRemovalChangeType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__DELETE_CHANGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__DELETE_CHANGE));
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__REMOVE_CHANGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.ELEMENT_DELETION_AND_REMOVAL_CHANGE_TYPE__REMOVE_CHANGE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_InvariantViolationEvent(ISerializationContext context, InvariantViolationEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.INVARIANT_VIOLATION_EVENT__VIOLATION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.INVARIANT_VIOLATION_EVENT__VIOLATION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getInvariantViolationEventAccess().getViolationEClassQualifiedNameParserRuleCall_1_0_1(), semanticObject.eGet(LanguagePackage.Literals.INVARIANT_VIOLATION_EVENT__VIOLATION, false));
		feeder.finish();
	}
	...
	protected void sequence_ModelAttributeChange(ISerializationContext context, ModelAttributeInsertedChange semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.MODEL_ATTRIBUTE_CHANGE__FEATURE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.MODEL_ATTRIBUTE_CHANGE__FEATURE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 *
	 * Constraint:
	 *     (documentation=ML_COMMENT? overriddenReactionsSegment=[ReactionsSegment|ID]? name=ValidID trigger=Trigger callRoutine=ReactionRoutineCall)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ValidID fromDomain=DomainReference toDomain=DomainReference reactionsImports+=ReactionsImport* (reactions+=Reaction | routines+=Routine)*)
	 */
	 ...
	 *     (firstElement=ExistingElementReference secondElement=ExistingElementReference tag=TagCodeBlock?)
	 */
	protected void sequence_RemoveCorrespondenceStatement_Taggable(ISerializationContext context, RemoveCorrespondence semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     MatcherStatement returns RequireAbscenceOfModelElement
	 *     RetrieveOrRequireAbscenceOfModelElement returns RequireAbscenceOfModelElement
	 *
	 * Constraint:
	 *     (elementType=UnnamedMetaclassReference correspondenceSource=CorrespondingObjectCodeBlock tag=TagCodeBlock? precondition=PreconditionCodeBlock?)
	 */
	protected void sequence_RequireAbscenceOfModelElement_RetrieveOrRequireAbscenceOfModelElement_Taggable(ISerializationContext context, RequireAbscenceOfModelElement semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ValidID? retrievalType=RetrieveModelElementTypeStatement)
	 */
	 ...
	 *     )
	 */
	protected void sequence_RetrieveModelElement_RetrieveOrRequireAbscenceOfModelElement_Taggable(ISerializationContext context, RetrieveModelElement semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_UpdateModelElementStatement(ISerializationContext context, UpdateModelElement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.UPDATE_MODEL_ELEMENT__ELEMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.UPDATE_MODEL_ELEMENT__ELEMENT));
			if (transientValues.isValueTransient(semanticObject, LanguagePackage.Literals.UPDATE_MODEL_ELEMENT__UPDATE_BLOCK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, LanguagePackage.Literals.UPDATE_MODEL_ELEMENT__UPDATE_BLOCK));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
