 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.ElementDeletionAndCreationAndReplacementChangeTypeImpl#getDeleteChange <em>Delete Change</em>}</li>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.ElementDeletionAndCreationAndReplacementChangeTypeImpl#getCreateChange <em>Create Change</em>}</li>
 *   <li>{@link tools.vitruv.dsls.reactions.language.impl.ElementDeletionAndCreationAndReplacementChangeTypeImpl#getReplacedChange <em>Replaced Change</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementDeletionAndCreationAndReplacementChangeTypeImpl extends ElementCompoundChangeTypeImpl implements ElementDeletionAndCreationAndReplacementChangeType
{
  ...
  {
    return LanguagePackage.Literals.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE;
  }
  ...
  public NotificationChain basicSetDeleteChange(ElementDeletionChangeType newDeleteChange, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__DELETE_CHANGE, oldDeleteChange, newDeleteChange);
  ...
  public void setDeleteChange(ElementDeletionChangeType newDeleteChange)
  {
    if (newDeleteChange != deleteChange)
    {
      ...
      if (deleteChange != null)
        msgs = ((InternalEObject)deleteChange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__DELETE_CHANGE, null, msgs);
      if (newDeleteChange != null)
        msgs = ((InternalEObject)newDeleteChange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__DELETE_CHANGE, null, msgs);
      msgs = basicSetDeleteChange(newDeleteChange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__DELETE_CHANGE, newDeleteChange, newDeleteChange));
  }
  ...
  public NotificationChain basicSetCreateChange(ElementCreationChangeType newCreateChange, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__CREATE_CHANGE, oldCreateChange, newCreateChange);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCreateChange(ElementCreationChangeType newCreateChange)
  {
    if (newCreateChange != createChange)
    {
      ...
      if (createChange != null)
        msgs = ((InternalEObject)createChange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__CREATE_CHANGE, null, msgs);
      if (newCreateChange != null)
        msgs = ((InternalEObject)newCreateChange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__CREATE_CHANGE, null, msgs);
      msgs = basicSetCreateChange(newCreateChange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__CREATE_CHANGE, newCreateChange, newCreateChange));
  }
  ...
  public NotificationChain basicSetReplacedChange(ElementReplacementChangeType newReplacedChange, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__REPLACED_CHANGE, oldReplacedChange, newReplacedChange);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setReplacedChange(ElementReplacementChangeType newReplacedChange)
  {
    if (newReplacedChange != replacedChange)
    {
      ...
      if (replacedChange != null)
        msgs = ((InternalEObject)replacedChange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__REPLACED_CHANGE, null, msgs);
      if (newReplacedChange != null)
        msgs = ((InternalEObject)newReplacedChange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__REPLACED_CHANGE, null, msgs);
      msgs = basicSetReplacedChange(newReplacedChange, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__REPLACED_CHANGE, newReplacedChange, newReplacedChange));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__DELETE_CHANGE:
        return basicSetDeleteChange(null, msgs);
      case LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__CREATE_CHANGE:
        return basicSetCreateChange(null, msgs);
      case LanguagePackage.ELEMENT_DELETION_AND_CREATION_AND_REPLACEMENT_CHANGE_TYPE__REPLACED_CHANGE:
