...
public class ReactionsLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ReactionsLanguageGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getReactionsSegmentAccess().getAlternatives_13(), "rule__ReactionsSegment__Alternatives_13");
			builder.put(grammarAccess.getTriggerAccess().getAlternatives_1(), "rule__Trigger__Alternatives_1");
			builder.put(grammarAccess.getModelChangeAccess().getAlternatives(), "rule__ModelChange__Alternatives");
			...
			builder.put(grammarAccess.getElementCompoundChangeTypeAccess().getAlternatives(), "rule__ElementCompoundChangeType__Alternatives");
			...
			builder.put(grammarAccess.getMatcherStatementAccess().getAlternatives(), "rule__MatcherStatement__Alternatives");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getAlternatives_0(), "rule__RetrieveOrRequireAbscenceOfModelElement__Alternatives_0");
			...
			builder.put(grammarAccess.getActionStatementAccess().getAlternatives(), "rule__ActionStatement__Alternatives");
			...
			builder.put(grammarAccess.getRetrieveOneElementTypeAccess().getAlternatives(), "rule__RetrieveOneElementType__Alternatives");
			...
			builder.put(grammarAccess.getInvariantViolationEventAccess().getGroup(), "rule__InvariantViolationEvent__Group__0");
			...
			builder.put(grammarAccess.getElementCreationAndInsertionChangeTypeAccess().getGroup(), "rule__ElementCreationAndInsertionChangeType__Group__0");
			builder.put(grammarAccess.getElementDeletionAndRemovalChangeTypeAccess().getGroup(), "rule__ElementDeletionAndRemovalChangeType__Group__0");
			builder.put(grammarAccess.getElementDeletionAndCreationAndReplacementChangeTypeAccess().getGroup(), "rule__ElementDeletionAndCreationAndReplacementChangeType__Group__0");
			...
			builder.put(grammarAccess.getMatcherBlockAccess().getGroup(), "rule__MatcherBlock__Group__0");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getGroup(), "rule__RetrieveOrRequireAbscenceOfModelElement__Group__0");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getGroup_5(), "rule__RetrieveOrRequireAbscenceOfModelElement__Group_5__0");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getGroup_6(), "rule__RetrieveOrRequireAbscenceOfModelElement__Group_6__0");
			...
			builder.put(grammarAccess.getMatcherCheckStatementAccess().getGroup(), "rule__MatcherCheckStatement__Group__0");
			builder.put(grammarAccess.getActionBlockAccess().getGroup(), "rule__ActionBlock__Group__0");
			builder.put(grammarAccess.getRoutineCallStatementAccess().getGroup(), "rule__RoutineCallStatement__Group__0");
			builder.put(grammarAccess.getExecuteActionStatementAccess().getGroup(), "rule__ExecuteActionStatement__Group__0");
			builder.put(grammarAccess.getCreateModelElementStatementAccess().getGroup(), "rule__CreateModelElementStatement__Group__0");
			builder.put(grammarAccess.getCreateModelElementStatementAccess().getGroup_6(), "rule__CreateModelElementStatement__Group_6__0");
			builder.put(grammarAccess.getDeleteModelElementStatementAccess().getGroup(), "rule__DeleteModelElementStatement__Group__0");
			builder.put(grammarAccess.getUpdateModelElementStatementAccess().getGroup(), "rule__UpdateModelElementStatement__Group__0");
			builder.put(grammarAccess.getCreateCorrespondenceStatementAccess().getGroup(), "rule__CreateCorrespondenceStatement__Group__0");
			builder.put(grammarAccess.getCreateCorrespondenceStatementAccess().getGroup_7(), "rule__CreateCorrespondenceStatement__Group_7__0");
			builder.put(grammarAccess.getRemoveCorrespondenceStatementAccess().getGroup(), "rule__RemoveCorrespondenceStatement__Group__0");
			builder.put(grammarAccess.getRemoveCorrespondenceStatementAccess().getGroup_7(), "rule__RemoveCorrespondenceStatement__Group_7__0");
			builder.put(grammarAccess.getRoutineCallBlockAccess().getGroup(), "rule__RoutineCallBlock__Group__0");
			builder.put(grammarAccess.getTagCodeBlockAccess().getGroup(), "rule__TagCodeBlock__Group__0");
			builder.put(grammarAccess.getPreconditionCodeBlockAccess().getGroup(), "rule__PreconditionCodeBlock__Group__0");
			builder.put(grammarAccess.getCorrespondingObjectCodeBlockAccess().getGroup(), "rule__CorrespondingObjectCodeBlock__Group__0");
			builder.put(grammarAccess.getExecutionCodeBlockAccess().getGroup(), "rule__ExecutionCodeBlock__Group__0");
			...
			builder.put(grammarAccess.getReactionsSegmentAccess().getFromDomainAssignment_7(), "rule__ReactionsSegment__FromDomainAssignment_7");
			builder.put(grammarAccess.getReactionsSegmentAccess().getToDomainAssignment_11(), "rule__ReactionsSegment__ToDomainAssignment_11");
			builder.put(grammarAccess.getReactionsSegmentAccess().getReactionsImportsAssignment_12(), "rule__ReactionsSegment__ReactionsImportsAssignment_12");
			builder.put(grammarAccess.getReactionsSegmentAccess().getReactionsAssignment_13_0(), "rule__ReactionsSegment__ReactionsAssignment_13_0");
			builder.put(grammarAccess.getReactionsSegmentAccess().getRoutinesAssignment_13_1(), "rule__ReactionsSegment__RoutinesAssignment_13_1");
			...
			builder.put(grammarAccess.getInvariantViolationEventAccess().getViolationAssignment_1(), "rule__InvariantViolationEvent__ViolationAssignment_1");
			builder.put(grammarAccess.getTriggerAccess().getPreconditionAssignment_2_1(), "rule__Trigger__PreconditionAssignment_2_1");
			...
			builder.put(grammarAccess.getElementCreationAndInsertionChangeTypeAccess().getCreateChangeAssignment_0(), "rule__ElementCreationAndInsertionChangeType__CreateChangeAssignment_0");
			builder.put(grammarAccess.getElementCreationAndInsertionChangeTypeAccess().getInsertChangeAssignment_2(), "rule__ElementCreationAndInsertionChangeType__InsertChangeAssignment_2");
			builder.put(grammarAccess.getElementDeletionAndRemovalChangeTypeAccess().getDeleteChangeAssignment_0(), "rule__ElementDeletionAndRemovalChangeType__DeleteChangeAssignment_0");
			builder.put(grammarAccess.getElementDeletionAndRemovalChangeTypeAccess().getRemoveChangeAssignment_2(), "rule__ElementDeletionAndRemovalChangeType__RemoveChangeAssignment_2");
			builder.put(grammarAccess.getElementDeletionAndCreationAndReplacementChangeTypeAccess().getDeleteChangeAssignment_0(), "rule__ElementDeletionAndCreationAndReplacementChangeType__DeleteChangeAssignment_0");
			builder.put(grammarAccess.getElementDeletionAndCreationAndReplacementChangeTypeAccess().getCreateChangeAssignment_2(), "rule__ElementDeletionAndCreationAndReplacementChangeType__CreateChangeAssignment_2");
			builder.put(grammarAccess.getElementDeletionAndCreationAndReplacementChangeTypeAccess().getReplacedChangeAssignment_4(), "rule__ElementDeletionAndCreationAndReplacementChangeType__ReplacedChangeAssignment_4");
			...
			builder.put(grammarAccess.getRoutineAccess().getMatcherAssignment_6(), "rule__Routine__MatcherAssignment_6");
			builder.put(grammarAccess.getRoutineAccess().getActionAssignment_7(), "rule__Routine__ActionAssignment_7");
			...
			builder.put(grammarAccess.getMatcherBlockAccess().getMatcherStatementsAssignment_3(), "rule__MatcherBlock__MatcherStatementsAssignment_3");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getElementTypeAssignment_1(), "rule__RetrieveOrRequireAbscenceOfModelElement__ElementTypeAssignment_1");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getCorrespondenceSourceAssignment_4(), "rule__RetrieveOrRequireAbscenceOfModelElement__CorrespondenceSourceAssignment_4");
			builder.put(grammarAccess.getRetrieveOrRequireAbscenceOfModelElementAccess().getPreconditionAssignment_6_1(), "rule__RetrieveOrRequireAbscenceOfModelElement__PreconditionAssignment_6_1");
			...
			builder.put(grammarAccess.getMatcherCheckStatementAccess().getAssertedAssignment_2(), "rule__MatcherCheckStatement__AssertedAssignment_2");
			builder.put(grammarAccess.getActionBlockAccess().getActionStatementsAssignment_3(), "rule__ActionBlock__ActionStatementsAssignment_3");
			builder.put(grammarAccess.getCreateModelElementStatementAccess().getNameAssignment_2(), "rule__CreateModelElementStatement__NameAssignment_2");
			builder.put(grammarAccess.getCreateModelElementStatementAccess().getElementTypeAssignment_5(), "rule__CreateModelElementStatement__ElementTypeAssignment_5");
			builder.put(grammarAccess.getCreateModelElementStatementAccess().getInitializationBlockAssignment_6_2(), "rule__CreateModelElementStatement__InitializationBlockAssignment_6_2");
			builder.put(grammarAccess.getDeleteModelElementStatementAccess().getElementAssignment_2(), "rule__DeleteModelElementStatement__ElementAssignment_2");
			builder.put(grammarAccess.getUpdateModelElementStatementAccess().getElementAssignment_2(), "rule__UpdateModelElementStatement__ElementAssignment_2");
			builder.put(grammarAccess.getUpdateModelElementStatementAccess().getUpdateBlockAssignment_3(), "rule__UpdateModelElementStatement__UpdateBlockAssignment_3");
			builder.put(grammarAccess.getCreateCorrespondenceStatementAccess().getFirstElementAssignment_4(), "rule__CreateCorrespondenceStatement__FirstElementAssignment_4");
			builder.put(grammarAccess.getCreateCorrespondenceStatementAccess().getSecondElementAssignment_6(), "rule__CreateCorrespondenceStatement__SecondElementAssignment_6");
			builder.put(grammarAccess.getRemoveCorrespondenceStatementAccess().getFirstElementAssignment_4(), "rule__RemoveCorrespondenceStatement__FirstElementAssignment_4");
			builder.put(grammarAccess.getRemoveCorrespondenceStatementAccess().getSecondElementAssignment_6(), "rule__RemoveCorrespondenceStatement__SecondElementAssignment_6");
			builder.put(grammarAccess.getCodeBlockAccess().getCodeAssignment(), "rule__CodeBlock__CodeAssignment");
			builder.put(grammarAccess.getTaggableAccess().getTagAssignment(), "rule__Taggable__TagAssignment");
			...
			builder.put(grammarAccess.getDomainReferenceAccess().getDomainAssignment(), "rule__DomainReference__DomainAssignment");
