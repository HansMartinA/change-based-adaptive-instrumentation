...
public interface ElementsPackage extends EPackage
{
	...
	/**
	 * The meta object id for the '{@link tools.vitruv.dsls.common.elements.impl.DomainReferenceImpl <em>Domain Reference</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.dsls.common.elements.impl.DomainReferenceImpl
	 * @see tools.vitruv.dsls.common.elements.impl.ElementsPackageImpl#getDomainReference()
	 * @generated
	 */
	int DOMAIN_REFERENCE = 6;
	...
	/**
	 * The number of operations of the '<em>Domain Reference</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DOMAIN_REFERENCE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruv.dsls.common.elements.DomainReference <em>Domain Reference</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Domain Reference</em>'.
	 * @see tools.vitruv.dsls.common.elements.DomainReference
	 * @generated
	 */
	EClass getDomainReference();

	/**
	 * Returns the meta object for the attribute '{@link tools.vitruv.dsls.common.elements.DomainReference#getDomain <em>Domain</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Domain</em>'.
	 * @see tools.vitruv.dsls.common.elements.DomainReference#getDomain()
	...
	interface Literals
	{
		...
		/**
		 * The meta object literal for the '{@link tools.vitruv.dsls.common.elements.impl.DomainReferenceImpl <em>Domain Reference</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.dsls.common.elements.impl.DomainReferenceImpl
		 * @see tools.vitruv.dsls.common.elements.impl.ElementsPackageImpl#getDomainReference()
