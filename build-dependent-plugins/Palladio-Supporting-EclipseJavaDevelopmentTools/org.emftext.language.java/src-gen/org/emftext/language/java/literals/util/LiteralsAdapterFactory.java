...
public class LiteralsAdapterFactory extends AdapterFactoryImpl
{
	...
	protected LiteralsSwitch<Adapter> modelSwitch =
		new LiteralsSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseBinaryIntegerLiteral(BinaryIntegerLiteral object)
			{
				return createBinaryIntegerLiteralAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseBinaryLongLiteral(BinaryLongLiteral object)
			{
				return createBinaryLongLiteralAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.literals.BinaryIntegerLiteral <em>Binary Integer Literal</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.literals.BinaryLongLiteral <em>Binary Long Literal</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
