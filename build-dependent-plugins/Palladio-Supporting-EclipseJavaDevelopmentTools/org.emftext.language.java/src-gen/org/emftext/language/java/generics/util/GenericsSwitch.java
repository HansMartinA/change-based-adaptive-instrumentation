	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case GenericsPackage.EXTENDS_TYPE_ARGUMENT:
			{
				...
				if (result == null) result = caseAnnotable(extendsTypeArgument);
			...
			case GenericsPackage.SUPER_TYPE_ARGUMENT:
			{
				...
				if (result == null) result = caseAnnotable(superTypeArgument);
			...
			case GenericsPackage.TYPE_PARAMETER:
			{
				...
				if (result == null) result = caseAnnotable(typeParameter);
			...
			case GenericsPackage.UNKNOWN_TYPE_ARGUMENT:
			{
				...
				if (result == null) result = caseAnnotable(unknownTypeArgument);
