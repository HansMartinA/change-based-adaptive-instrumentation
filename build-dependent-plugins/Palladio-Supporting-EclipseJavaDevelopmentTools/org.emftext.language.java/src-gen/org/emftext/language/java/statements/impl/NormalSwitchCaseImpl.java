 ...
 *   <li>{@link org.emftext.language.java.statements.impl.NormalSwitchCaseImpl#getAdditionalConditions <em>Additional Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NormalSwitchCaseImpl extends SwitchCaseImpl implements NormalSwitchCase
{
	...
	public EList<Expression> getAdditionalConditions()
	{
		...
		{
			additionalConditions = new EObjectContainmentEList.Resolving<Expression>(Expression.class, this, StatementsPackage.NORMAL_SWITCH_CASE__ADDITIONAL_CONDITIONS);
		}
