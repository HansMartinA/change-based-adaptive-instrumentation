...
public interface MembersPackage extends EPackage
{
	 ...
	 * @ordered
	 */
	int ADDITIONAL_FIELD__INITIAL_VALUE = ReferencesPackage.REFERENCEABLE_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ADDITIONAL_FIELD__TYPE_REFERENCE = ReferencesPackage.REFERENCEABLE_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ADDITIONAL_FIELD_FEATURE_COUNT = ReferencesPackage.REFERENCEABLE_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int CONSTRUCTOR__TYPE_PARAMETERS = MEMBER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CONSTRUCTOR__EXCEPTIONS = MEMBER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int CONSTRUCTOR__ANNOTATIONS_AND_MODIFIERS = MEMBER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int CONSTRUCTOR__BLOCK = MEMBER_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int FIELD__TYPE_ARGUMENTS = MEMBER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FIELD__ANNOTATIONS_AND_MODIFIERS = MEMBER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int FIELD__ADDITIONAL_FIELDS = MEMBER_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int METHOD__TYPE_PARAMETERS = MEMBER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int METHOD__PARAMETERS = MEMBER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int METHOD__EXCEPTIONS = MEMBER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int METHOD__ANNOTATIONS_AND_MODIFIERS = MEMBER_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int METHOD__STATEMENT = MEMBER_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int INTERFACE_METHOD__STATEMENT = METHOD__STATEMENT;
	 ...
	 * @ordered
	 */
	int INTERFACE_METHOD__DEFAULT_VALUE = METHOD_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INTERFACE_METHOD_FEATURE_COUNT = METHOD_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CLASS_METHOD__STATEMENT = METHOD__STATEMENT;
	 ...
	 * @ordered
	 */
	int CLASS_METHOD_FEATURE_COUNT = METHOD_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference '{@link org.emftext.language.java.members.InterfaceMethod#getDefaultValue <em>Default Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Default Value</em>'.
	 * @see org.emftext.language.java.members.InterfaceMethod#getDefaultValue()
	...
	interface Literals
	{
		 ...
		 * @generated
		 */
		EReference INTERFACE_METHOD__DEFAULT_VALUE = eINSTANCE.getInterfaceMethod_DefaultValue();
