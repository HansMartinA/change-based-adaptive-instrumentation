	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case AnnotationsPackage.ANNOTATION_INSTANCE:
			{
				...
				if (result == null) result = caseTypedElementExtension(annotationInstance);
				if (result == null) result = caseMethodReferenceExpressionChild(annotationInstance);
				...
				if (result == null) result = caseLambdaBody(annotationInstance);
