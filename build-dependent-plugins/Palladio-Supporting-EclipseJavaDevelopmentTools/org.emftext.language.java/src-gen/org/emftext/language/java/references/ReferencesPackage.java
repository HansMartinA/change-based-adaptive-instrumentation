...
public interface ReferencesPackage extends EPackage
{
	 ...
	 * @ordered
	 */
	int REFERENCE__ACTUAL_TARGETS = ExpressionsPackage.PRIMARY_EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int REFERENCE__NEXT = ExpressionsPackage.PRIMARY_EXPRESSION_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int REFERENCE__ARRAY_SELECTORS = ExpressionsPackage.PRIMARY_EXPRESSION_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int REFERENCE_FEATURE_COUNT = ExpressionsPackage.PRIMARY_EXPRESSION_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int ELEMENT_REFERENCE__ACTUAL_TARGETS = REFERENCE__ACTUAL_TARGETS;
	...
	/**
	 * The feature id for the '<em><b>Contained Target</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ELEMENT_REFERENCE__CONTAINED_TARGET = REFERENCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int IDENTIFIER_REFERENCE__ACTUAL_TARGETS = ELEMENT_REFERENCE__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int IDENTIFIER_REFERENCE__CONTAINED_TARGET = ELEMENT_REFERENCE__CONTAINED_TARGET;
	 ...
	 * @ordered
	 */
	int IDENTIFIER_REFERENCE__ANNOTATIONS = ELEMENT_REFERENCE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int IDENTIFIER_REFERENCE__ARRAY_DIMENSIONS_BEFORE = ELEMENT_REFERENCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int IDENTIFIER_REFERENCE__ARRAY_DIMENSIONS_AFTER = ELEMENT_REFERENCE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int IDENTIFIER_REFERENCE_FEATURE_COUNT = ELEMENT_REFERENCE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int METHOD_CALL__ACTUAL_TARGETS = ELEMENT_REFERENCE__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int METHOD_CALL__CONTAINED_TARGET = ELEMENT_REFERENCE__CONTAINED_TARGET;
	 ...
	 * @ordered
	 */
	int REFLECTIVE_CLASS_REFERENCE__ACTUAL_TARGETS = REFERENCE__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE_REFERENCE__ACTUAL_TARGETS = REFERENCE__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE_REFERENCE__ARRAY_DIMENSIONS_BEFORE = REFERENCE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE_REFERENCE__ARRAY_DIMENSIONS_AFTER = REFERENCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE_REFERENCE__PRIMITIVE_TYPE = REFERENCE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE_REFERENCE_FEATURE_COUNT = REFERENCE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int STRING_REFERENCE__ACTUAL_TARGETS = REFERENCE__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int SELF_REFERENCE__ACTUAL_TARGETS = REFERENCE__ACTUAL_TARGETS;
	...
	/**
	 * The meta object id for the '{@link org.emftext.language.java.references.impl.TextBlockReferenceImpl <em>Text Block Reference</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.emftext.language.java.references.impl.TextBlockReferenceImpl
	 * @see org.emftext.language.java.references.impl.ReferencesPackageImpl#getTextBlockReference()
	 * @generated
	 */
	int TEXT_BLOCK_REFERENCE = 10;
	 ...
	 * @ordered
	 */
	int TEXT_BLOCK_REFERENCE__LAYOUT_INFORMATIONS = REFERENCE__LAYOUT_INFORMATIONS;
	 ...
	 * @ordered
	 */
	int TEXT_BLOCK_REFERENCE__TYPE_ARGUMENTS = REFERENCE__TYPE_ARGUMENTS;
	 ...
	 * @ordered
	 */
	int TEXT_BLOCK_REFERENCE__ACTUAL_TARGETS = REFERENCE__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int TEXT_BLOCK_REFERENCE__NEXT = REFERENCE__NEXT;
	 ...
	 * @ordered
	 */
	int TEXT_BLOCK_REFERENCE__ARRAY_SELECTORS = REFERENCE__ARRAY_SELECTORS;
	 ...
	 * @ordered
	 */
	int TEXT_BLOCK_REFERENCE__VALUE = REFERENCE_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Text Block Reference</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TEXT_BLOCK_REFERENCE_FEATURE_COUNT = REFERENCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int PACKAGE_REFERENCE__NAMESPACES = REFERENCEABLE_ELEMENT_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference '{@link org.emftext.language.java.references.ElementReference#getContainedTarget <em>Contained Target</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Contained Target</em>'.
	 * @see org.emftext.language.java.references.ElementReference#getContainedTarget()
	 * @see #getElementReference()
	 * @generated
	 */
	EReference getElementReference_ContainedTarget();
	...
	/**
	 * Returns the meta object for class '{@link org.emftext.language.java.references.TextBlockReference <em>Text Block Reference</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Text Block Reference</em>'.
	 * @see org.emftext.language.java.references.TextBlockReference
	 * @generated
	 */
	EClass getTextBlockReference();

	/**
	 * Returns the meta object for the attribute '{@link org.emftext.language.java.references.TextBlockReference#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see org.emftext.language.java.references.TextBlockReference#getValue()
	 * @see #getTextBlockReference()
	 * @generated
	 */
	...
	interface Literals
	{
		...
		/**
		 * The meta object literal for the '<em><b>Contained Target</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference ELEMENT_REFERENCE__CONTAINED_TARGET = eINSTANCE.getElementReference_ContainedTarget();
		...
		/**
		 * The meta object literal for the '{@link org.emftext.language.java.references.impl.TextBlockReferenceImpl <em>Text Block Reference</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.emftext.language.java.references.impl.TextBlockReferenceImpl
		 * @see org.emftext.language.java.references.impl.ReferencesPackageImpl#getTextBlockReference()
		 * @generated
		 */
		EClass TEXT_BLOCK_REFERENCE = eINSTANCE.getTextBlockReference();
		 ...
		 * @generated
		 */
		EAttribute TEXT_BLOCK_REFERENCE__VALUE = eINSTANCE.getTextBlockReference_Value();
