...
public class ExpressionsAdapterFactory extends AdapterFactoryImpl
{
	...
	protected ExpressionsSwitch<Adapter> modelSwitch =
		new ExpressionsSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseMethodReferenceExpression(MethodReferenceExpression object)
			{
				return createMethodReferenceExpressionAdapter();
			}
			@Override
			public Adapter casePrimaryExpressionReferenceExpression(PrimaryExpressionReferenceExpression object)
			{
				return createPrimaryExpressionReferenceExpressionAdapter();
			}
			@Override
			public Adapter caseClassTypeConstructorReferenceExpression(ClassTypeConstructorReferenceExpression object)
			{
				return createClassTypeConstructorReferenceExpressionAdapter();
			}
			@Override
			public Adapter caseArrayConstructorReferenceExpression(ArrayConstructorReferenceExpression object)
			{
				return createArrayConstructorReferenceExpressionAdapter();
			}
			@Override
			public Adapter caseMethodReferenceExpressionChild(MethodReferenceExpressionChild object)
			{
				return createMethodReferenceExpressionChildAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseLambdaParameters(LambdaParameters object)
			{
				return createLambdaParametersAdapter();
			}
			@Override
			public Adapter caseExplicitlyTypedLambdaParameters(ExplicitlyTypedLambdaParameters object)
			{
				return createExplicitlyTypedLambdaParametersAdapter();
			}
			@Override
			public Adapter caseImplicitlyTypedLambdaParameters(ImplicitlyTypedLambdaParameters object)
			{
				return createImplicitlyTypedLambdaParametersAdapter();
			}
			@Override
			public Adapter caseSingleImplicitLambdaParameter(SingleImplicitLambdaParameter object)
			{
				return createSingleImplicitLambdaParameterAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseTypedElementExtension(TypedElementExtension object)
			{
				return createTypedElementExtensionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.MethodReferenceExpression <em>Method Reference Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.PrimaryExpressionReferenceExpression <em>Primary Expression Reference Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.ClassTypeConstructorReferenceExpression <em>Class Type Constructor Reference Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.ArrayConstructorReferenceExpression <em>Array Constructor Reference Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.MethodReferenceExpressionChild <em>Method Reference Expression Child</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.LambdaExpression <em>Lambda Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.LambdaParameters <em>Lambda Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.ExplicitlyTypedLambdaParameters <em>Explicitly Typed Lambda Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.ImplicitlyTypedLambdaParameters <em>Implicitly Typed Lambda Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.expressions.SingleImplicitLambdaParameter <em>Single Implicit Lambda Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.types.TypedElementExtension <em>Typed Element Extension</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
