 ...
 *   <li>{@link org.emftext.language.java.instantiations.impl.NewConstructorCallImpl#getActualTargets <em>Actual Targets</em>}</li>
...
public class NewConstructorCallImpl extends TypedElementImpl implements NewConstructorCall
{
	...
	public EList<TypeReference> getActualTargets()
	{
		...
		{
			actualTargets = new EObjectContainmentEList.Resolving<TypeReference>(TypeReference.class, this, InstantiationsPackage.NEW_CONSTRUCTOR_CALL__ACTUAL_TARGETS);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == TypedElementExtension.class)
		{
			switch (derivedFeatureID)
			{
				case InstantiationsPackage.NEW_CONSTRUCTOR_CALL__ACTUAL_TARGETS: return TypesPackage.TYPED_ELEMENT_EXTENSION__ACTUAL_TARGETS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == TypedElementExtension.class)
		{
			switch (baseFeatureID)
			{
				case TypesPackage.TYPED_ELEMENT_EXTENSION__ACTUAL_TARGETS: return InstantiationsPackage.NEW_CONSTRUCTOR_CALL__ACTUAL_TARGETS;
				default: return -1;
			}
		}
		if (baseClass == Reference.class)
