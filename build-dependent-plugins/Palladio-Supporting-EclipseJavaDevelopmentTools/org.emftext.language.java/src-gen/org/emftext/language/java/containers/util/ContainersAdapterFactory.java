...
public class ContainersAdapterFactory extends AdapterFactoryImpl
{
	...
	protected ContainersSwitch<Adapter> modelSwitch =
		new ContainersSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseModule(org.emftext.language.java.containers.Module object)
			{
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.containers.Module <em>Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
