...
public class ParametersPackageImpl extends EPackageImpl implements ParametersPackage
{
	 ...
	 * @generated
	 */
	private EClass catchParameterEClass = null;
	 ...
	 */
	@Override
	public EReference getCatchParameter_TypeReferences()
	{
		return (EReference)catchParameterEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getReceiverParameter_OuterTypeReference()
	{
	 ...
	 */
	@Override
	public EReference getReceiverParameter_ThisReference()
	{
	...
	public void createPackageContents()
	{
		...
		catchParameterEClass = createEClass(CATCH_PARAMETER);
		createEReference(catchParameterEClass, CATCH_PARAMETER__TYPE_REFERENCES);

		receiverParameterEClass = createEClass(RECEIVER_PARAMETER);
		createEReference(receiverParameterEClass, RECEIVER_PARAMETER__OUTER_TYPE_REFERENCE);
		createEReference(receiverParameterEClass, RECEIVER_PARAMETER__THIS_REFERENCE);
	}
	...
	public void initializePackageContents()
	{
		...
		variableLengthParameterEClass.getESuperTypes().add(theAnnotationsPackage.getAnnotable());
		catchParameterEClass.getESuperTypes().add(this.getOrdinaryParameter());
		receiverParameterEClass.getESuperTypes().add(this.getParameter());
		receiverParameterEClass.getESuperTypes().add(theAnnotationsPackage.getAnnotable());
		...
		initEClass(catchParameterEClass, CatchParameter.class, "CatchParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCatchParameter_TypeReferences(), theTypesPackage.getTypeReference(), null, "typeReferences", null, 0, -1, CatchParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getReceiverParameter_OuterTypeReference(), theTypesPackage.getTypeReference(), null, "outerTypeReference", null, 0, 1, ReceiverParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getReceiverParameter_ThisReference(), theLiteralsPackage.getThis(), null, "thisReference", null, 1, 1, ReceiverParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
