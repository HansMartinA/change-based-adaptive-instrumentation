 ...
 *   <li>{@link org.emftext.language.java.references.impl.ReferenceImpl#getActualTargets <em>Actual Targets</em>}</li>
...
public abstract class ReferenceImpl extends PrimaryExpressionImpl implements Reference
{
	...
	public EList<TypeReference> getActualTargets()
	{
		...
		{
			actualTargets = new EObjectContainmentEList.Resolving<TypeReference>(TypeReference.class, this, ReferencesPackage.REFERENCE__ACTUAL_TARGETS);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == TypedElementExtension.class)
		{
			switch (derivedFeatureID)
			{
				case ReferencesPackage.REFERENCE__ACTUAL_TARGETS: return TypesPackage.TYPED_ELEMENT_EXTENSION__ACTUAL_TARGETS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == TypedElementExtension.class)
		{
			switch (baseFeatureID)
			{
				case TypesPackage.TYPED_ELEMENT_EXTENSION__ACTUAL_TARGETS: return ReferencesPackage.REFERENCE__ACTUAL_TARGETS;
				default: return -1;
			}
		}
