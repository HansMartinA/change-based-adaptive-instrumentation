	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case InstantiationsPackage.INSTANTIATION:
			{
				...
				if (result == null) result = caseTypedElementExtension(instantiation);
			...
			case InstantiationsPackage.NEW_CONSTRUCTOR_CALL:
			{
				...
				if (result == null) result = caseTypedElementExtension(newConstructorCall);
			...
			case InstantiationsPackage.NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS:
			{
				...
				if (result == null) result = caseTypedElementExtension(newConstructorCallWithInferredTypeArguments);
			...
			case InstantiationsPackage.EXPLICIT_CONSTRUCTOR_CALL:
			{
				...
				if (result == null) result = caseTypedElementExtension(explicitConstructorCall);
