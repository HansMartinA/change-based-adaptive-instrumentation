...
public class ModifiersFactoryImpl extends EFactoryImpl implements ModifiersFactory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID())
		{
			...
			case ModifiersPackage.DEFAULT: return createDefault();
			case ModifiersPackage.TRANSITIVE: return createTransitive();
			case ModifiersPackage.OPEN: return createOpen();
			default:
