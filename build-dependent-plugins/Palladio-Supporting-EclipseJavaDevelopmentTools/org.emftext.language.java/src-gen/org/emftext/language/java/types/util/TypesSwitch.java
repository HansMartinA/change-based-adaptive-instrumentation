...
public class TypesSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case TypesPackage.TYPED_ELEMENT_EXTENSION:
			{
				TypedElementExtension typedElementExtension = (TypedElementExtension)theEObject;
				T result = caseTypedElementExtension(typedElementExtension);
				if (result == null) result = caseCommentable(typedElementExtension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypesPackage.TYPE_REFERENCE:
			{
				...
				if (result == null) result = caseArrayTypeable(typeReference);
			...
			case TypesPackage.CLASSIFIER_REFERENCE:
			{
				...
				if (result == null) result = caseAnnotable(classifierReference);
				if (result == null) result = caseArrayTypeable(classifierReference);
			...
			case TypesPackage.NAMESPACE_CLASSIFIER_REFERENCE:
			{
				...
				if (result == null) result = caseArrayTypeable(namespaceClassifierReference);
			...
			case TypesPackage.PRIMITIVE_TYPE:
			{
				...
				if (result == null) result = caseAnnotable(primitiveType);
				if (result == null) result = caseArrayTypeable(primitiveType);
			...
			case TypesPackage.BOOLEAN:
			{
				...
				if (result == null) result = caseArrayTypeable(boolean_);
			...
			case TypesPackage.BYTE:
			{
				...
				if (result == null) result = caseAnnotable(byte_);
				if (result == null) result = caseArrayTypeable(byte_);
			...
			case TypesPackage.CHAR:
			{
				...
				if (result == null) result = caseAnnotable(char_);
				if (result == null) result = caseArrayTypeable(char_);
			...
			case TypesPackage.DOUBLE:
			{
				...
				if (result == null) result = caseAnnotable(double_);
				if (result == null) result = caseArrayTypeable(double_);
			...
			case TypesPackage.FLOAT:
			{
				...
				if (result == null) result = caseArrayTypeable(float_);
			...
			case TypesPackage.INT:
			{
				...
				if (result == null) result = caseAnnotable(int_);
				if (result == null) result = caseArrayTypeable(int_);
			...
			case TypesPackage.LONG:
			{
				...
				if (result == null) result = caseAnnotable(long_);
				if (result == null) result = caseArrayTypeable(long_);
			...
			case TypesPackage.SHORT:
			{
				...
				if (result == null) result = caseAnnotable(short_);
				if (result == null) result = caseArrayTypeable(short_);
			...
			case TypesPackage.VOID:
			{
				...
				if (result == null) result = caseAnnotable(void_);
				if (result == null) result = caseArrayTypeable(void_);
				if (result == null) result = caseCommentable(void_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypesPackage.INFERABLE_TYPE:
			{
				InferableType inferableType = (InferableType)theEObject;
				T result = caseInferableType(inferableType);
				if (result == null) result = caseTypeReference(inferableType);
				if (result == null) result = caseTypedElementExtension(inferableType);
				if (result == null) result = caseArrayTypeable(inferableType);
				if (result == null) result = caseCommentable(inferableType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inferable Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inferable Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
