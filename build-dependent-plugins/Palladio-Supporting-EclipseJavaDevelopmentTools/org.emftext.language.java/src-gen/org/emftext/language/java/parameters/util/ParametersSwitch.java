...
public class ParametersSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case ParametersPackage.VARIABLE_LENGTH_PARAMETER:
			{
				...
				if (result == null) result = caseAnnotable(variableLengthParameter);
			...
			case ParametersPackage.CATCH_PARAMETER:
			{
				CatchParameter catchParameter = (CatchParameter)theEObject;
				T result = caseCatchParameter(catchParameter);
				if (result == null) result = caseOrdinaryParameter(catchParameter);
				if (result == null) result = caseParameter(catchParameter);
				if (result == null) result = caseVariable(catchParameter);
				if (result == null) result = caseAnnotableAndModifiable(catchParameter);
				if (result == null) result = caseTypedElement(catchParameter);
				if (result == null) result = caseReferenceableElement(catchParameter);
				if (result == null) result = caseTypeArgumentable(catchParameter);
				if (result == null) result = caseNamedElement(catchParameter);
				if (result == null) result = caseCommentable(catchParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParametersPackage.RECEIVER_PARAMETER:
			{
				ReceiverParameter receiverParameter = (ReceiverParameter)theEObject;
				T result = caseReceiverParameter(receiverParameter);
				if (result == null) result = caseParameter(receiverParameter);
				if (result == null) result = caseAnnotable(receiverParameter);
				if (result == null) result = caseVariable(receiverParameter);
				if (result == null) result = caseAnnotableAndModifiable(receiverParameter);
				if (result == null) result = caseTypedElement(receiverParameter);
				if (result == null) result = caseReferenceableElement(receiverParameter);
				if (result == null) result = caseTypeArgumentable(receiverParameter);
				if (result == null) result = caseNamedElement(receiverParameter);
				if (result == null) result = caseCommentable(receiverParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Catch Parameter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Catch Parameter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCatchParameter(CatchParameter object)
	{
		return null;
	}
