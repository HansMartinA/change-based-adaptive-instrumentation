	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case MembersPackage.ADDITIONAL_FIELD:
			{
				...
				if (result == null) result = caseTypedElement(additionalField);
			...
			case MembersPackage.CONSTRUCTOR:
			{
				...
				if (result == null) result = caseBlockContainer(constructor);
			...
			case MembersPackage.INTERFACE_METHOD:
			{
				...
				if (result == null) result = caseStatementContainer(interfaceMethod);
			...
			case MembersPackage.CLASS_METHOD:
			{
				...
				if (result == null) result = caseStatementContainer(classMethod);
