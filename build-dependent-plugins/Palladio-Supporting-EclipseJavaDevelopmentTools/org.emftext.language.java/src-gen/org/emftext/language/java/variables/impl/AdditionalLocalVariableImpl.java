 ...
 *   <li>{@link org.emftext.language.java.variables.impl.AdditionalLocalVariableImpl#getTypeReference <em>Type Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalLocalVariableImpl extends ReferenceableElementImpl implements AdditionalLocalVariable
{
	...
	public TypeReference getTypeReference()
	{
		if (typeReference != null && typeReference.eIsProxy())
		{
			...
			if (typeReference != oldTypeReference)
			{
				...
				NotificationChain msgs = oldTypeReference.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE, null, null);
				if (newTypeReference.eInternalContainer() == null)
				{
					msgs = newTypeReference.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE, oldTypeReference, typeReference));
			}
		}
	...
	public NotificationChain basicSetTypeReference(TypeReference newTypeReference, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE, oldTypeReference, newTypeReference);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTypeReference(TypeReference newTypeReference)
	{
		if (newTypeReference != typeReference)
		{
			...
			if (typeReference != null)
				msgs = ((InternalEObject)typeReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE, null, msgs);
			if (newTypeReference != null)
				msgs = ((InternalEObject)newTypeReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE, null, msgs);
			msgs = basicSetTypeReference(newTypeReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE, newTypeReference, newTypeReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == TypedElement.class)
		{
			switch (derivedFeatureID)
			{
				case VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE: return TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == TypedElement.class)
		{
			switch (baseFeatureID)
			{
				case TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE: return VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__TYPE_REFERENCE;
				default: return -1;
			}
		}
