...
public class InstantiationsAdapterFactory extends AdapterFactoryImpl
{
	...
	protected InstantiationsSwitch<Adapter> modelSwitch =
		new InstantiationsSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseNewConstructorCallWithInferredTypeArguments(NewConstructorCallWithInferredTypeArguments object)
			{
				return createNewConstructorCallWithInferredTypeArgumentsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.instantiations.NewConstructorCallWithInferredTypeArguments <em>New Constructor Call With Inferred Type Arguments</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
