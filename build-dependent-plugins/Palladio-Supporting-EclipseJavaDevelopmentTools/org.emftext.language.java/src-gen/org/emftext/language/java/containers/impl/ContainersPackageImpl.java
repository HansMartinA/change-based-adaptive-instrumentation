...
public class ContainersPackageImpl extends EPackageImpl implements ContainersPackage
{
	 ...
	 */
	@Override
	public EAttribute getJavaRoot_Origin()
	{
		return (EAttribute)javaRootEClass.getEStructuralFeatures().get(0);
	}
	...
	public void initializePackageContents()
	{
		...
		javaRootEClass.getESuperTypes().add(theAnnotationsPackage.getAnnotable());
		...
		moduleEClass.getESuperTypes().add(this.getJavaRoot());

		// Initialize classes and features; add operations and parameters
		initEClass(javaRootEClass, JavaRoot.class, "JavaRoot", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getJavaRoot_Origin(), this.getOrigin(), "origin", null, 1, 1, JavaRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPackage_Module(), this.getModule(), null, "module", null, 0, 1, org.emftext.language.java.containers.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackage_Classifiers(), theClassifiersPackage.getConcreteClassifier(), null, "classifiers", null, 0, -1, org.emftext.language.java.containers.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(emptyModelEClass, EmptyModel.class, "EmptyModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(moduleEClass, org.emftext.language.java.containers.Module.class, "Module", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModule_Open(), theModifiersPackage.getOpen(), null, "open", null, 0, 1, org.emftext.language.java.containers.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModule_Target(), theModulesPackage.getModuleDirective(), null, "target", null, 0, -1, org.emftext.language.java.containers.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModule_Packages(), this.getPackage(), null, "packages", null, 0, -1, org.emftext.language.java.containers.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(originEEnum, Origin.class, "Origin");
		addEEnumLiteral(originEEnum, Origin.FILE);
		addEEnumLiteral(originEEnum, Origin.CLASS);
		addEEnumLiteral(originEEnum, Origin.ARCHIVE);
		addEEnumLiteral(originEEnum, Origin.BINDING);
