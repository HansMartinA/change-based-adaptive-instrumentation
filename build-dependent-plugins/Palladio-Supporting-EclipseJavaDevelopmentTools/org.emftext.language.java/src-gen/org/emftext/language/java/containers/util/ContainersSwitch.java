...
public class ContainersSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case ContainersPackage.JAVA_ROOT:
			{
				...
				if (result == null) result = caseAnnotable(javaRoot);
			...
			case ContainersPackage.COMPILATION_UNIT:
			{
				...
				if (result == null) result = caseAnnotable(compilationUnit);
			...
			case ContainersPackage.PACKAGE:
			{
				...
				if (result == null) result = caseReferenceableElement(package_);
			...
			case ContainersPackage.EMPTY_MODEL:
			{
				...
				if (result == null) result = caseAnnotable(emptyModel);
				if (result == null) result = caseCommentable(emptyModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ContainersPackage.MODULE:
			{
				org.emftext.language.java.containers.Module module = (org.emftext.language.java.containers.Module)theEObject;
				T result = caseModule(module);
				if (result == null) result = caseJavaRoot(module);
				if (result == null) result = caseNamedElement(module);
				if (result == null) result = caseNamespaceAwareElement(module);
				if (result == null) result = caseImportingElement(module);
				if (result == null) result = caseAnnotable(module);
	 ...
	 * @generated
	 */
	public T caseModule(org.emftext.language.java.containers.Module object)
	{
		return null;
	}
