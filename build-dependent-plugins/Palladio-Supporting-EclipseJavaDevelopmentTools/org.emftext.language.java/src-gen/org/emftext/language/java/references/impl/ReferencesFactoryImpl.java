...
public class ReferencesFactoryImpl extends EFactoryImpl implements ReferencesFactory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID())
		{
			...
			case ReferencesPackage.TEXT_BLOCK_REFERENCE: return createTextBlockReference();
	...
	{
		TextBlockReferenceImpl textBlockReference = new TextBlockReferenceImpl();
		return textBlockReference;
	}
