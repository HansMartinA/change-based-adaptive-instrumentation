...
public interface InstantiationsPackage extends EPackage
{
	 ...
	 * @ordered
	 */
	int INSTANTIATION__ACTUAL_TARGETS = ReferencesPackage.REFERENCE__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int INSTANTIATION__CALL_TYPE_ARGUMENTS = ReferencesPackage.REFERENCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int INSTANTIATION_FEATURE_COUNT = ReferencesPackage.REFERENCE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL__ACTUAL_TARGETS = TypesPackage.TYPED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL__NEXT = TypesPackage.TYPED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL__ARRAY_SELECTORS = TypesPackage.TYPED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL__ARGUMENTS = TypesPackage.TYPED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL__CALL_TYPE_ARGUMENTS = TypesPackage.TYPED_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL__ANONYMOUS_CLASS = TypesPackage.TYPED_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_FEATURE_COUNT = TypesPackage.TYPED_ELEMENT_FEATURE_COUNT + 7;

	/**
	 * The meta object id for the '{@link org.emftext.language.java.instantiations.impl.NewConstructorCallWithInferredTypeArgumentsImpl <em>New Constructor Call With Inferred Type Arguments</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.emftext.language.java.instantiations.impl.NewConstructorCallWithInferredTypeArgumentsImpl
	 * @see org.emftext.language.java.instantiations.impl.InstantiationsPackageImpl#getNewConstructorCallWithInferredTypeArguments()
	 * @generated
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS = 3;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__LAYOUT_INFORMATIONS = NEW_CONSTRUCTOR_CALL__LAYOUT_INFORMATIONS;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__TYPE_REFERENCE = NEW_CONSTRUCTOR_CALL__TYPE_REFERENCE;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__TYPE_ARGUMENTS = NEW_CONSTRUCTOR_CALL__TYPE_ARGUMENTS;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__ACTUAL_TARGETS = NEW_CONSTRUCTOR_CALL__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__NEXT = NEW_CONSTRUCTOR_CALL__NEXT;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__ARRAY_SELECTORS = NEW_CONSTRUCTOR_CALL__ARRAY_SELECTORS;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__ARGUMENTS = NEW_CONSTRUCTOR_CALL__ARGUMENTS;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__CALL_TYPE_ARGUMENTS = NEW_CONSTRUCTOR_CALL__CALL_TYPE_ARGUMENTS;
	 ...
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS__ANONYMOUS_CLASS = NEW_CONSTRUCTOR_CALL__ANONYMOUS_CLASS;

	/**
	 * The number of structural features of the '<em>New Constructor Call With Inferred Type Arguments</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS_FEATURE_COUNT = NEW_CONSTRUCTOR_CALL_FEATURE_COUNT + 0;
	 ...
	 * @generated
	 */
	int EXPLICIT_CONSTRUCTOR_CALL = 4;
	 ...
	 * @ordered
	 */
	int EXPLICIT_CONSTRUCTOR_CALL__ACTUAL_TARGETS = INSTANTIATION__ACTUAL_TARGETS;
	 ...
	 * @ordered
	 */
	int EXPLICIT_CONSTRUCTOR_CALL__CALL_TYPE_ARGUMENTS = INSTANTIATION__CALL_TYPE_ARGUMENTS;
	...
	/**
	 * Returns the meta object for class '{@link org.emftext.language.java.instantiations.NewConstructorCallWithInferredTypeArguments <em>New Constructor Call With Inferred Type Arguments</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>New Constructor Call With Inferred Type Arguments</em>'.
	 * @see org.emftext.language.java.instantiations.NewConstructorCallWithInferredTypeArguments
	 * @generated
	 */
	...
	interface Literals
	{
		...
		/**
		 * The meta object literal for the '{@link org.emftext.language.java.instantiations.impl.NewConstructorCallWithInferredTypeArgumentsImpl <em>New Constructor Call With Inferred Type Arguments</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.emftext.language.java.instantiations.impl.NewConstructorCallWithInferredTypeArgumentsImpl
		 * @see org.emftext.language.java.instantiations.impl.InstantiationsPackageImpl#getNewConstructorCallWithInferredTypeArguments()
		 * @generated
		 */
		EClass NEW_CONSTRUCTOR_CALL_WITH_INFERRED_TYPE_ARGUMENTS = eINSTANCE.getNewConstructorCallWithInferredTypeArguments();
