...
public class ReferencesAdapterFactory extends AdapterFactoryImpl
{
	...
	protected ReferencesSwitch<Adapter> modelSwitch =
		new ReferencesSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseTextBlockReference(TextBlockReference object)
			{
				return createTextBlockReferenceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.references.TextBlockReference <em>Text Block Reference</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTextBlockReferenceAdapter()
	{
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.variables.Resource <em>Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.emftext.language.java.variables.Resource
	 * @generated
	 */
