...
public class ParametersAdapterFactory extends AdapterFactoryImpl
{
	...
	protected ParametersSwitch<Adapter> modelSwitch =
		new ParametersSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseCatchParameter(CatchParameter object)
			{
				return createCatchParameterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.parameters.CatchParameter <em>Catch Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.parameters.ReceiverParameter <em>Receiver Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
