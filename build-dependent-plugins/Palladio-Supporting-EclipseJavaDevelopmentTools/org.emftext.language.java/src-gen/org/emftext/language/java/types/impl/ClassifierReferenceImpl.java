 ...
 *   <li>{@link org.emftext.language.java.types.impl.ClassifierReferenceImpl#getAnnotations <em>Annotations</em>}</li>
...
public class ClassifierReferenceImpl extends TypeReferenceImpl implements ClassifierReference
{
	...
	public EList<AnnotationInstance> getAnnotations()
	{
		if (annotations == null)
		{
			annotations = new EObjectContainmentEList.Resolving<AnnotationInstance>(AnnotationInstance.class, this, TypesPackage.CLASSIFIER_REFERENCE__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case TypesPackage.CLASSIFIER_REFERENCE__ANNOTATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == Annotable.class)
		{
			switch (derivedFeatureID)
			{
				case TypesPackage.CLASSIFIER_REFERENCE__ANNOTATIONS: return AnnotationsPackage.ANNOTABLE__ANNOTATIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		...
		if (baseClass == Annotable.class)
		{
			switch (baseFeatureID)
			{
				case AnnotationsPackage.ANNOTABLE__ANNOTATIONS: return TypesPackage.CLASSIFIER_REFERENCE__ANNOTATIONS;
				default: return -1;
			}
		}
