...
public class TypesAdapterFactory extends AdapterFactoryImpl
{
	...
	protected TypesSwitch<Adapter> modelSwitch =
		new TypesSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseInferableType(InferableType object)
			{
				return createInferableTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.language.java.types.InferableType <em>Inferable Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
