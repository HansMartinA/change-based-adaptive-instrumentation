...
/**
 * This is the item provider adapter for a {@link org.emftext.language.java.parameters.ReceiverParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReceiverParameterItemProvider extends ParameterItemProvider
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(ParametersPackage.Literals.RECEIVER_PARAMETER__OUTER_TYPE_REFERENCE);
			childrenFeatures.add(ParametersPackage.Literals.RECEIVER_PARAMETER__THIS_REFERENCE);
		}
	...
	{
		String label = ((ReceiverParameter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ReceiverParameter_type") :
			getString("_UI_ReceiverParameter_type") + " " + label;
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
	{
		...
		boolean qualify =
			...
			childFeature == ParametersPackage.Literals.RECEIVER_PARAMETER__OUTER_TYPE_REFERENCE;
