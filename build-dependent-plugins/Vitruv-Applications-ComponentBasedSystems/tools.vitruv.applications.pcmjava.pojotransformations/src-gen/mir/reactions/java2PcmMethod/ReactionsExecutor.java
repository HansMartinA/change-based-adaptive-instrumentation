...
class ReactionsExecutor extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    this.addReaction(new mir.reactions.java2PcmMethod.MemberRenamedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("java2PcmMethod"))));
    ...
    this.addReaction(new mir.reactions.java2PcmMethod.ParameterTypeChangedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("java2PcmMethod"))));
