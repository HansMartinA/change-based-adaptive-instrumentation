...
public class JavaReturnTypeChangedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.java2PcmMethod.JavaReturnTypeChangedReaction.ActionUserExecution userExecution = new mir.reactions.java2PcmMethod.JavaReturnTypeChangedReaction.ActionUserExecution(this.executionState, this);
