...
public class MemberRenamedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.java2PcmMethod.MemberRenamedReaction.ActionUserExecution userExecution = new mir.reactions.java2PcmMethod.MemberRenamedReaction.ActionUserExecution(this.executionState, this);
