...
class ReactionsExecutor extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(new mir.reactions.java2PcmClassifier.JavaPackageRenamedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("java2PcmClassifier"))));
    this.addReaction(new mir.reactions.java2PcmClassifier.JavaPackageRemovedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("java2PcmClassifier"))));
    ...
    this.addReaction(new mir.reactions.java2PcmClassifier.JavaInterfaceRenamedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("java2PcmClassifier"))));
    this.addReaction(new mir.reactions.java2PcmClassifier.JavaClassRenamedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("java2PcmClassifier"))));
