...
public class ClassCreatedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.java2PcmClassifier.ClassCreatedReaction.ActionUserExecution userExecution = new mir.reactions.java2PcmClassifier.ClassCreatedReaction.ActionUserExecution(this.executionState, this);
