...
public class AddDataTypeInRepositoryRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public DataType getElement1(final DataType pcmDataType, final Repository pcmRepository) {
      return pcmDataType;
    }
    ...
    public Repository getElement2(final DataType pcmDataType, final Repository pcmRepository) {
  ...
  protected boolean executeRoutine() throws IOException {
    if (getLogger().isTraceEnabled()) {
    	getLogger().trace("Called routine AddDataTypeInRepositoryRoutine with input:");
    	getLogger().trace("   pcmDataType: " + this.pcmDataType);
    }
