...
public class CreateParameterRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine2(final OrdinaryParameter javaParameter, final Parametrizable javaMethod, final OperationSignature operationSignature, final Parameter pcmParameter, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeParameterType(javaParameter.getTypeReference(), javaParameter);
    }
    ...
    public void callRoutine1(final OrdinaryParameter javaParameter, final Parametrizable javaMethod, final OperationSignature operationSignature, final Parameter pcmParameter, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeParameterName(javaParameter.getName(), javaParameter);
    }
  }
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    userExecution.callRoutine1(javaParameter, javaMethod, operationSignature, pcmParameter, this.getRoutinesFacade());
