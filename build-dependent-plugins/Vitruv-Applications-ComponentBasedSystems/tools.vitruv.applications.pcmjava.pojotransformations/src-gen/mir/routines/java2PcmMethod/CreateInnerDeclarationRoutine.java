...
public class CreateInnerDeclarationRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void updateInnerDeclarationElement(final ConcreteClassifier classifier, final Field javaField, final CompositeDataType compositeDataType, final InnerDeclaration innerDeclaration) {
      ...
      TypeReference _typeReference = javaField.getTypeReference();
      boolean _tripleNotEquals = (_typeReference != null);
      if (_tripleNotEquals) {
        _xifexpression = TypeReferenceCorrespondenceHelper.getDataTypeFromTypeReference(javaField.getTypeReference(), this.executionState.getCorrespondenceModel(), this.executionState.getUserInteractor(), null);
      } else {
        _xifexpression = null;
      }
