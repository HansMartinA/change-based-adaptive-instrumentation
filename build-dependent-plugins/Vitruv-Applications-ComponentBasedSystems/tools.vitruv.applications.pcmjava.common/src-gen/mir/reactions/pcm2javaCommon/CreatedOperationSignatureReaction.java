...
public class CreatedOperationSignatureReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.CreatedOperationSignatureReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.CreatedOperationSignatureReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean matchCreateChange(final EChange change) {
    if (change instanceof CreateEObject<?>) {
    	CreateEObject<org.palladiosimulator.pcm.repository.OperationSignature> _localTypedChange = (CreateEObject<org.palladiosimulator.pcm.repository.OperationSignature>) change;
    	if (!(_localTypedChange.getAffectedEObject() instanceof org.palladiosimulator.pcm.repository.OperationSignature)) {
    		return false;
    	}
    	this.createChange = (CreateEObject<org.palladiosimulator.pcm.repository.OperationSignature>) change;
    	return true;
    }
