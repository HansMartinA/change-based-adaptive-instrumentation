...
public class DeletedCollectionDataTypeReaction extends AbstractReactionRealization {
  ...
  public DeletedCollectionDataTypeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.DeletedCollectionDataTypeReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.DeletedCollectionDataTypeReaction.ActionUserExecution(this.executionState, this);
