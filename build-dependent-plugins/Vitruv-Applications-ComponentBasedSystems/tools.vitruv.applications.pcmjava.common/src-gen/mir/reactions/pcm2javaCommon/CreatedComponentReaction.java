...
public class CreatedComponentReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.CreatedComponentReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.CreatedComponentReaction.ActionUserExecution(this.executionState, this);
