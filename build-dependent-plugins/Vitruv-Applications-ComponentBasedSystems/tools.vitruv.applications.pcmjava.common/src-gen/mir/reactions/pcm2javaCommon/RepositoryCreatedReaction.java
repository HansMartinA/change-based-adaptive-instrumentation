...
public class RepositoryCreatedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.RepositoryCreatedReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.RepositoryCreatedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertRootEObject insertChange, final Repository newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.addRepositoryCorrespondence(newValue);
    }
  }
}
