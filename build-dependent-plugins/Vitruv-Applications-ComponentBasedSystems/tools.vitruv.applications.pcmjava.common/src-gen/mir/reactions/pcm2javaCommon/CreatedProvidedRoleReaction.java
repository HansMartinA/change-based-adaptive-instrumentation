...
public class CreatedProvidedRoleReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.CreatedProvidedRoleReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.CreatedProvidedRoleReaction.ActionUserExecution(this.executionState, this);
