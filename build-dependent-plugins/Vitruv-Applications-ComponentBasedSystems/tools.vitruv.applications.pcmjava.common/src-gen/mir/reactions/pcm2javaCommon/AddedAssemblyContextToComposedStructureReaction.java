...
public class AddedAssemblyContextToComposedStructureReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.AddedAssemblyContextToComposedStructureReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.AddedAssemblyContextToComposedStructureReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final ComposedStructure affectedEObject, final EReference affectedFeature, final AssemblyContext newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.createOrFindAssemblyContextField(newValue, affectedEObject);
      _routinesFacade.createOrFindAssemblyContextConstructor(newValue, affectedEObject);
      _routinesFacade.createOrFindAssemblyContextImport(newValue, affectedEObject);
    }
  }
}
