...
class ReactionsExecutor extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    this.addReaction(new mir.reactions.pcm2javaCommon.RepositoryCreatedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("pcm2javaCommon"))));
    ...
    this.addReaction(new mir.reactions.pcm2javaCommon.RepositoryDeletedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("pcm2javaCommon"))));
