...
public class RenamedParameterReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.RenamedParameterReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.RenamedParameterReaction.ActionUserExecution(this.executionState, this);
