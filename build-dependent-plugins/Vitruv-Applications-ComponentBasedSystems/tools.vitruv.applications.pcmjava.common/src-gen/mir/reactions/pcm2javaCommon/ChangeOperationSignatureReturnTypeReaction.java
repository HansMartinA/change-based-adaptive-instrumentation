...
public class ChangeOperationSignatureReturnTypeReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.pcm2javaCommon.ChangeOperationSignatureReturnTypeReaction.ActionUserExecution userExecution = new mir.reactions.pcm2javaCommon.ChangeOperationSignatureReturnTypeReaction.ActionUserExecution(this.executionState, this);
