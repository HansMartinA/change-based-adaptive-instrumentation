...
public class AddSuperTypeToDataTypeRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public CompilationUnit getElement1(final DataType dataType, final TypeReference innerTypeReference, final String superTypeQualifiedName, final org.emftext.language.java.classifiers.Class dataTypeImplementation, final CompilationUnit dataTypeImplementationCU) {
  ...
  protected boolean executeRoutine() throws IOException {
    if (getLogger().isTraceEnabled()) {
    	...
    	getLogger().trace("   innerTypeReference: " + this.innerTypeReference);
    	getLogger().trace("   superTypeQualifiedName: " + this.superTypeQualifiedName);
    }
