...
public class AddRequiredRoleRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public EObject getElement6(final OperationRequiredRole requiredRole, final Interface requiredInterface, final org.emftext.language.java.classifiers.Class javaClass, final ClassifierImport requiredInterfaceImport, final Field requiredInterfaceField) {
      return requiredRole;
    }
    ...
    public org.emftext.language.java.classifiers.Class getElement7(final OperationRequiredRole requiredRole, final Interface requiredInterface, final org.emftext.language.java.classifiers.Class javaClass, final ClassifierImport requiredInterfaceImport, final Field requiredInterfaceField) {
      return javaClass;
    }
    ...
    public EObject getElement1(final OperationRequiredRole requiredRole, final Interface requiredInterface, final org.emftext.language.java.classifiers.Class javaClass) {
      return javaClass;
    }
    
    public EObject getElement4(final OperationRequiredRole requiredRole, final Interface requiredInterface, final org.emftext.language.java.classifiers.Class javaClass, final ClassifierImport requiredInterfaceImport) {
      return requiredRole;
    }
    ...
    public EObject getElement2(final OperationRequiredRole requiredRole, final Interface requiredInterface, final org.emftext.language.java.classifiers.Class javaClass) {
      return requiredRole;
    }
    
    public EObject getElement3(final OperationRequiredRole requiredRole, final Interface requiredInterface, final org.emftext.language.java.classifiers.Class javaClass, final ClassifierImport requiredInterfaceImport) {
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    addCorrespondenceBetween(userExecution.getElement1(requiredRole, requiredInterface, javaClass), userExecution.getElement2(requiredRole, requiredInterface, javaClass), "");
    ...
    addCorrespondenceBetween(userExecution.getElement3(requiredRole, requiredInterface, javaClass, requiredInterfaceImport), userExecution.getElement4(requiredRole, requiredInterface, javaClass, requiredInterfaceImport), "");
    ...
    addCorrespondenceBetween(userExecution.getElement5(requiredRole, requiredInterface, javaClass, requiredInterfaceImport, requiredInterfaceField), userExecution.getElement6(requiredRole, requiredInterface, javaClass, requiredInterfaceImport, requiredInterfaceField), "");
    
    // val updatedElement userExecution.getElement7(requiredRole, requiredInterface, javaClass, requiredInterfaceImport, requiredInterfaceField);
