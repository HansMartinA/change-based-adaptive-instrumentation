...
public class RenameComponentPackageAndClassRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public boolean getCorrespondingModelElementsPreconditionRepositoryPackage(final RepositoryComponent component, final org.emftext.language.java.containers.Package repositoryPackage) {
      ...
      String _entityName = component.getRepository__RepositoryComponent().getEntityName();
      boolean _equals = Objects.equal(_name, _entityName);
      return _equals;
    }
  ...
  public RenameComponentPackageAndClassRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final RepositoryComponent component) {
  ...
  protected boolean executeRoutine() throws IOException {
    if (getLogger().isTraceEnabled()) {
    	getLogger().trace("Called routine RenameComponentPackageAndClassRoutine with input:");
