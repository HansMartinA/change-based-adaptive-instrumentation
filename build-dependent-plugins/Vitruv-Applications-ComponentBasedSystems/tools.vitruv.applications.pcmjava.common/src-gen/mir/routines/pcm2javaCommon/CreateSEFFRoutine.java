...
public class CreateSEFFRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void update0Element(final ServiceEffectSpecification seff, final org.emftext.language.java.classifiers.Class componentClass, final InterfaceMethod interfaceMethod, final ClassMethod classMethod) {
      ClassMethod correspondingClassMethod = JavaMemberAndParameterUtil.findMethodInClass(componentClass, classMethod);
    ...
    public void updateClassMethodElement(final ServiceEffectSpecification seff, final org.emftext.language.java.classifiers.Class componentClass, final InterfaceMethod interfaceMethod, final ClassMethod classMethod) {
      JavaMemberAndParameterUtil.initializeClassMethod(classMethod, interfaceMethod, true);
    }
    
    public org.emftext.language.java.classifiers.Class getElement3(final ServiceEffectSpecification seff, final org.emftext.language.java.classifiers.Class componentClass, final InterfaceMethod interfaceMethod, final ClassMethod classMethod) {
  ...
  protected boolean executeRoutine() throws IOException {
    if (getLogger().isTraceEnabled()) {
    	getLogger().trace("Called routine CreateSEFFRoutine with input:");
