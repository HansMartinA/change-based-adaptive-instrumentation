...
public class RenameParameterRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public OrdinaryParameter getElement1(final Parameter parameter, final OrdinaryParameter javaParameter) {
  ...
  protected boolean executeRoutine() throws IOException {
    if (getLogger().isTraceEnabled()) {
    	getLogger().trace("Called routine RenameParameterRoutine with input:");
