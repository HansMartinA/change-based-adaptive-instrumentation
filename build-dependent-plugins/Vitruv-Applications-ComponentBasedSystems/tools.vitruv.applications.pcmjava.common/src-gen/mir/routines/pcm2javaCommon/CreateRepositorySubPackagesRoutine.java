...
public class CreateRepositorySubPackagesRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Repository repository, final org.emftext.language.java.containers.Package repositoryPackage, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.createOrFindJavaPackage(repository, repositoryPackage, "datatypes", "datatypes");
      _routinesFacade.createOrFindJavaPackage(repository, repositoryPackage, "contracts", "contracts");
    }
  }
  ...
  protected boolean executeRoutine() throws IOException {
    if (getLogger().isTraceEnabled()) {
    	getLogger().trace("Called routine CreateRepositorySubPackagesRoutine with input:");
    	getLogger().trace("   repository: " + this.repository);
    }
