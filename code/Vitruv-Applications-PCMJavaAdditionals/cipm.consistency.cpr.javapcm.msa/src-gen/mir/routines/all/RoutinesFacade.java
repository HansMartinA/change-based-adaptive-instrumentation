...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public boolean createOrFindCallTarget(final MethodCall methCall, final Method method) {
    mir.routines.methodBody.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody")));
    return _routinesFacade.createOrFindCallTarget(methCall, method);
  }
  
  public boolean renameMember(final Member javaMember) {
    mir.routines.classifierBody.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody")));
    return _routinesFacade.renameMember(javaMember);
  }
  
  public boolean removeFieldCorrespondence(final Field field) {
    mir.routines.classifierBody.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody")));
    return _routinesFacade.removeFieldCorrespondence(field);
  }
  
  public boolean decideInterfaceCreation(final ConcreteClassifier javaInterface) {
    mir.routines.classifier.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier")));
    return _routinesFacade.decideInterfaceCreation(javaInterface);
  }
  
  public boolean checkServletInterfaceCreation(final ConcreteClassifier javaInterface) {
    mir.routines.servlet.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.Servlet")));
  ...
  public boolean checkJaxRSPCMSignatureCreation(final Method interfaceMethod) {
    mir.routines.jaxRS.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.Servlet.JaxRS")));
  ...
  public boolean createInterface(final ConcreteClassifier javaInterface) {
    mir.routines.commonInterface.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.Servlet.JaxRS.common.commonInterface")));
  ...
  public boolean createOrFindOperationProvidedRoleFromTypeReference(final TypeReference typeReference) {
    mir.routines.commonOperationProvidedRole.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.Servlet.JaxRS.common.commonOperationProvidedRole")));
  ...
  public boolean checkImportForImportedRequiredRoles(final Import importSt) {
    mir.routines.commonOperationRequiredRole.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.Servlet.JaxRS.common.commonOperationRequiredRole")));
  ...
  public boolean createOrFindPCMSignature(final Method interfaceMethod) {
    mir.routines.commonSignature.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.Servlet.JaxRS.common.commonSignature")));
  ...
  public boolean checkInnerDeclarationsCreation(final DataType type, final TypeReference typeRef) {
    mir.routines.commonDataType.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.Servlet.JaxRS.common.commonSignature.commonDataType")));
  ...
  public boolean createOrFindArchitecturalElement(final ConcreteClassifier classifier) {
    mir.routines.component.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("methodBody.classifierBody.classifier.component")));
