...
public class CreateSEFFRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public BasicComponent getElement3(final Method javaMethod, final org.emftext.language.java.classifiers.Class javaClass, final ClassMethod classMethod, final OperationSignature operationSignature, final BasicComponent basicComponent, final ResourceDemandingSEFF rdseff) {
  ...
  public CreateSEFFRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Method javaMethod, final org.emftext.language.java.classifiers.Class javaClass, final ClassMethod classMethod) {
    ...
    this.userExecution = new mir.routines.commonSignature.CreateSEFFRoutine.ActionUserExecution(getExecutionState(), this);
