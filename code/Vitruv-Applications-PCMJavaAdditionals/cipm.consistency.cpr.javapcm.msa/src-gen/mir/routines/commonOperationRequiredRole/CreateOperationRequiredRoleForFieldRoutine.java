...
public class CreateOperationRequiredRoleForFieldRoutine extends AbstractRepairRoutineRealization {
  private CreateOperationRequiredRoleForFieldRoutine.ActionUserExecution userExecution;
  ...
  public CreateOperationRequiredRoleForFieldRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Field javaField, final OperationInterface operationInterface, final RepositoryComponent repoComponent) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.commonOperationRequiredRole.CreateOperationRequiredRoleForFieldRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    if (getLogger().isTraceEnabled()) {
    	getLogger().trace("Called routine CreateOperationRequiredRoleForFieldRoutine with input:");
