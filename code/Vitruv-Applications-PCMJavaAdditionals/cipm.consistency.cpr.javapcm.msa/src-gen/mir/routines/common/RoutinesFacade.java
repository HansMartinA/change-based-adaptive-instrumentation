...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public boolean createInterface(final ConcreteClassifier javaInterface) {
    mir.routines.commonInterface.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("commonInterface")));
  ...
  public boolean createOrFindOperationProvidedRoleFromTypeReference(final TypeReference typeReference) {
    mir.routines.commonOperationProvidedRole.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("commonOperationProvidedRole")));
  ...
  public boolean checkImportForImportedRequiredRoles(final Import importSt) {
    mir.routines.commonOperationRequiredRole.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("commonOperationRequiredRole")));
  ...
  public boolean checkInnerDeclarationsCreation(final DataType type, final TypeReference typeRef) {
    mir.routines.commonDataType.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("commonSignature.commonDataType")));
