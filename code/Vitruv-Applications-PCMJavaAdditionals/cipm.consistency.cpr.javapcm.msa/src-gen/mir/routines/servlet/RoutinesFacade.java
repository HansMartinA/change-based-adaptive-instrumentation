...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public boolean checkServletInterfaceCreation(final ConcreteClassifier javaInterface) {
    ...
    CheckServletInterfaceCreationRoutine routine = new CheckServletInterfaceCreationRoutine(_routinesFacade, _reactionExecutionState, _caller, javaInterface);
  ...
  public boolean createServletHierarchy(final org.emftext.language.java.classifiers.Class start) {
    ...
    ReactionExecutionState _reactionExecutionState = this._getExecutionState().getReactionExecutionState();
    CallHierarchyHaving _caller = this._getExecutionState().getCaller();
    CreateServletHierarchyRoutine routine = new CreateServletHierarchyRoutine(_routinesFacade, _reactionExecutionState, _caller, start);
    return routine.applyRoutine();
  }
  ...
  public boolean checkMembersForOperations(final ConcreteClassifier classifier) {
    ...
    ReactionExecutionState _reactionExecutionState = this._getExecutionState().getReactionExecutionState();
    CallHierarchyHaving _caller = this._getExecutionState().getCaller();
    CheckMembersForOperationsRoutine routine = new CheckMembersForOperationsRoutine(_routinesFacade, _reactionExecutionState, _caller, classifier);
    return routine.applyRoutine();
  }
  ...
  public boolean connectInterfacesByInheritance(final ConcreteClassifier subClassifier, final ConcreteClassifier superClassifier) {
    ...
    ReactionExecutionState _reactionExecutionState = this._getExecutionState().getReactionExecutionState();
    CallHierarchyHaving _caller = this._getExecutionState().getCaller();
    ConnectInterfacesByInheritanceRoutine routine = new ConnectInterfacesByInheritanceRoutine(_routinesFacade, _reactionExecutionState, _caller, subClassifier, superClassifier);
    return routine.applyRoutine();
  }
  
  public boolean checkJaxRSPCMSignatureCreation(final Method interfaceMethod) {
    mir.routines.jaxRS.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("JaxRS")));
  ...
  public boolean createInterface(final ConcreteClassifier javaInterface) {
    mir.routines.commonInterface.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("JaxRS.common.commonInterface")));
  ...
  public boolean createOrFindOperationProvidedRoleFromTypeReference(final TypeReference typeReference) {
    mir.routines.commonOperationProvidedRole.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("JaxRS.common.commonOperationProvidedRole")));
  ...
  public boolean checkImportForImportedRequiredRoles(final Import importSt) {
    mir.routines.commonOperationRequiredRole.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("JaxRS.common.commonOperationRequiredRole")));
  ...
  public boolean createOrFindPCMSignature(final Method interfaceMethod) {
    mir.routines.commonSignature.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("JaxRS.common.commonSignature")));
  ...
  public boolean checkInnerDeclarationsCreation(final DataType type, final TypeReference typeRef) {
    mir.routines.commonDataType.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(this._getReactionsImportPath().append(ReactionsImportPath.fromPathString("JaxRS.common.commonSignature.commonDataType")));
