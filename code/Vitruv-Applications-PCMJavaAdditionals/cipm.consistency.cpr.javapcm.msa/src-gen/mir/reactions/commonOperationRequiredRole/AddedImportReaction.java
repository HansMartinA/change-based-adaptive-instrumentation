...
public class AddedImportReaction extends AbstractReactionRealization {
  private InsertEReference<JavaRoot, Import> insertChange;
  
  private int currentlyMatchedChange;
  
  public AddedImportReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.commonOperationRequiredRole.AddedImportReaction.ActionUserExecution userExecution = new mir.reactions.commonOperationRequiredRole.AddedImportReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final JavaRoot affectedEObject, final EReference affectedFeature, final Import newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.checkImportForImportedRequiredRoles(newValue);
    }
  }
}
