...
public class AddedInterfaceReaction extends AbstractReactionRealization {
  private InsertEReference<CompilationUnit, Interface> insertChange;
  
  private int currentlyMatchedChange;
  
  public AddedInterfaceReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifier.AddedInterfaceReaction.ActionUserExecution userExecution = new mir.reactions.classifier.AddedInterfaceReaction.ActionUserExecution(this.executionState, this);
