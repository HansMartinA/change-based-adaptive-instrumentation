...
public class AddedTypeReferenceReaction extends AbstractReactionRealization {
  private InsertEReference<org.emftext.language.java.classifiers.Class, TypeReference> insertChange;
  
  private int currentlyMatchedChange;
  
  public AddedTypeReferenceReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.commonOperationProvidedRole.AddedTypeReferenceReaction.ActionUserExecution userExecution = new mir.reactions.commonOperationProvidedRole.AddedTypeReferenceReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final org.emftext.language.java.classifiers.Class affectedEObject, final EReference affectedFeature, final TypeReference newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.createOrFindOperationProvidedRoleFromTypeReference(newValue);
    }
  }
}
