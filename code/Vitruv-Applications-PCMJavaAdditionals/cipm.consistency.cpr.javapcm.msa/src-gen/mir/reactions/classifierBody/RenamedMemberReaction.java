...
public class RenamedMemberReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Member, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public RenamedMemberReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.RenamedMemberReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.RenamedMemberReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean checkUserDefinedPrecondition(final ReplaceSingleValuedEAttribute replaceChange, final Member affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue) {
    return ((!(affectedEObject instanceof ConcreteClassifier)) && (!(affectedEObject instanceof Field)));
  }
