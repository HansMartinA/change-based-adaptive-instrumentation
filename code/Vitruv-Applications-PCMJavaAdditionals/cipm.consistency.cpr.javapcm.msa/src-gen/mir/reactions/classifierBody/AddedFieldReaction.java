...
public class AddedFieldReaction extends AbstractReactionRealization {
  private InsertEReference<org.emftext.language.java.classifiers.Class, Field> insertChange;
  
  private int currentlyMatchedChange;
  
  public AddedFieldReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.AddedFieldReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.AddedFieldReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final org.emftext.language.java.classifiers.Class affectedEObject, final EReference affectedFeature, final Field newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      ...
      _routinesFacade.checkFieldForRequiredInterface(type, newValue);
    }
  }
}
