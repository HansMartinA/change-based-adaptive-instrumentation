...
public class RemovedClassMethodReaction extends AbstractReactionRealization {
  private RemoveEReference<org.emftext.language.java.classifiers.Class, ClassMethod> removeChange;
  
  private int currentlyMatchedChange;
  
  public RemovedClassMethodReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.RemovedClassMethodReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.RemovedClassMethodReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final org.emftext.language.java.classifiers.Class affectedEObject, final EReference affectedFeature, final ClassMethod oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.checkRemovalOfSEFF(oldValue);
      _routinesFacade.checkRemovalOfOperationSignature(oldValue);
    }
  }
}
