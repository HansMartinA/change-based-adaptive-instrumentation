...
public class RemovedInterfaceMethodReaction extends AbstractReactionRealization {
  private RemoveEReference<Interface, InterfaceMethod> removeChange;
  
  private int currentlyMatchedChange;
  
  public RemovedInterfaceMethodReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.RemovedInterfaceMethodReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.RemovedInterfaceMethodReaction.ActionUserExecution(this.executionState, this);
