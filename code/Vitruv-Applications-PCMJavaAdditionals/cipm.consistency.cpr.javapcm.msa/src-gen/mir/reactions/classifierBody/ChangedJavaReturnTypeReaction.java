...
public class ChangedJavaReturnTypeReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<Method, TypeReference> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangedJavaReturnTypeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.ChangedJavaReturnTypeReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.ChangedJavaReturnTypeReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEReference replaceChange, final Method affectedEObject, final EReference affectedFeature, final TypeReference oldValue, final TypeReference newValue, @Extension final RoutinesFacade _routinesFacade) {
      if ((newValue != null)) {
        _routinesFacade.updateReturnType(affectedEObject, newValue);
      }
    }
  }
}
