...
public class AddedInterfaceMethodReaction extends AbstractReactionRealization {
  private InsertEReference<Interface, InterfaceMethod> insertChange;
  
  private int currentlyMatchedChange;
  
  public AddedInterfaceMethodReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.AddedInterfaceMethodReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.AddedInterfaceMethodReaction.ActionUserExecution(this.executionState, this);
