...
public class AddedClassMethodReaction extends AbstractReactionRealization {
  private InsertEReference<org.emftext.language.java.classifiers.Class, ClassMethod> insertChange;
  
  private int currentlyMatchedChange;
  
  public AddedClassMethodReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.AddedClassMethodReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.AddedClassMethodReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final org.emftext.language.java.classifiers.Class affectedEObject, final EReference affectedFeature, final ClassMethod newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      boolean _isPublic = newValue.isPublic();
      if (_isPublic) {
        _routinesFacade.createOrFindPCMSignature(newValue);
      }
      _routinesFacade.createSeffFromImplementingInterfaces(newValue, affectedEObject);
      _routinesFacade.createSeffFromClassInterface(newValue, affectedEObject);
    }
  }
}
