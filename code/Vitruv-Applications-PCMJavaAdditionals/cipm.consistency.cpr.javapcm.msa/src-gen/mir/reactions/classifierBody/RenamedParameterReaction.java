...
/**
 * *
 * nNeeds a special reaction because Parameter is not a NamedElement.
 *  
 */
...
public class RenamedParameterReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.RenamedParameterReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.RenamedParameterReaction.ActionUserExecution(this.executionState, this);
