...
public class RemovedParameterReaction extends AbstractReactionRealization {
  private RemoveEReference<Parametrizable, OrdinaryParameter> removeChange;
  
  private int currentlyMatchedChange;
  
  public RemovedParameterReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.RemovedParameterReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.RemovedParameterReaction.ActionUserExecution(this.executionState, this);
